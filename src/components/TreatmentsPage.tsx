  ...
  const treatments = [
    {
      ...
      description:
        "Replace missing teeth with permanent titanium implants that look, feel, and function like natural teeth.",
      image:
        "https://images.unsplash.com/photo-1565090567208-c8038cfcf6cd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZW50YWwlMjBpbXBsYW50JTIwcHJvY2VkdXJlfGVufDF8fHx8MTc2MzI4MjUyOXww&ixlib=rb-4.1.0&q=80&w=1080",
    ...
    },
    {
      ...
      description:
        "Ultra-thin custom shells designed to cover the front surface of teeth for a perfect smile transformation.",
      image:
        "https://images.unsplash.com/photo-1656894592570-7c3af33e1477?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwZXJmZWN0JTIwc21pbGUlMjB2ZW5lZXJzfGVufDF8fHx8MTc2MzI4MjUyOXww&ixlib=rb-4.1.0&q=80&w=1080",
      priceIndia: "$300 - $450",
    ...
    },
    {
      ...
      description:
        "Comprehensive dental rehabilitation combining multiple procedures to restore function and aesthetics.",
      image:
    ...
    },
    {
      ...
      description:
        "Cosmetic dental procedures combined to create your dream smile with veneers, whitening, and contouring.",
      image:
        "https://images.unsplash.com/photo-1684607632845-723f8f427110?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZW50YWwlMjBjbGluaWMlMjBwYXRpZW50JTIwc21pbGluZ3xlbnwxfHx8fDE3NjMyNTE0OTZ8MA&ixlib=rb-4.1.0&q=80&w=1080",
    ...
    },
    {
      ...
      description:
        "Advanced endodontic therapy to save infected teeth using modern technology and pain-free techniques.",
      image:
    ...
    },
    {
      ...
      description:
        "Professional-grade whitening treatments for dramatically whiter teeth in just one session.",
      image:
        "https://images.unsplash.com/photo-1656894592570-7c3af33e1477?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwZXJmZWN0JTIwc21pbGUlMjB2ZW5lZXJzfGVufDF8fHx8MTc2MzI4MjUyOXww&ixlib=rb-4.1.0&q=80&w=1080",
      priceIndia: "$150 - $300",
      ...
      <div className="bg-gradient-to-r from-[#007AB6] to-[#00A676] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/90 max-w-2xl mx-auto mb-8">
            Explore our comprehensive range of dental treatments performed by
            world-class specialists in state-of-the-art facilities at affordable
            prices.
          </p>
          <Button
                    ...
                    <ul className="space-y-2">
                      {treatment.benefits.map((benefit, i) => (
                        <li key={i} className="flex items-start gap-2">
                          <Check
                            size={20}
                            className="text-[#00A676] mt-0.5 flex-shrink-0"
                          />
      ...
      <div className="py-16 bg-gradient-to-r from-[#007AB6]/10 to-[#00A676]/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Get a personalized treatment plan and free quote from our dental
            experts.
          </p>
          <Button
            onClick={() => navigate("/quote")}
