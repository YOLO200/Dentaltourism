...
export function DestinationsPage() {
  ...
  const destinations = [
    ...
    },
    {
      ...
      state: "Maharashtra",
      image:
        "https://images.unsplash.com/photo-1662408976803-d94e2e0cb57a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxNdW1iYWklMjBza3lsaW5lJTIwY2l0eXxlbnwxfHx8fDE3NjMyODI1Mjh8MA&ixlib=rb-4.1.0&q=80&w=1080",
      description:
        "India's financial capital and home to some of the country's most prestigious dental clinics. Experience world-class healthcare alongside vibrant city culture, Bollywood, and stunning coastal views.",
      clinics: 25,
      rating: 4.9,
      highlights: [
    ...
    },
    {
      ...
      state: "Delhi NCR",
      image:
        "https://images.unsplash.com/photo-1705077171489-b5dfcf144676?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxOZXclMjBEZWxoaSUyMEluZGlhJTIwZ2F0ZXxlbnwxfHx8fDE3NjMyODI1Mjh8MA&ixlib=rb-4.1.0&q=80&w=1080",
      description:
        "The capital city offers unparalleled healthcare infrastructure with government-accredited hospitals and private dental centers. Explore rich history and heritage between your appointments.",
      clinics: 30,
      rating: 4.8,
      highlights: [
    ...
    },
    {
      ...
      state: "Telangana",
      image:
        "https://images.unsplash.com/photo-1734183929831-0bbc0267ac8e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxIeWRlcmFiYWQlMjBjaXR5c2NhcGV8ZW58MXx8fHwxNzYzMjgyNTI5fDA&ixlib=rb-4.1.0&q=80&w=1080",
      description:
        "A technology and healthcare hub with ultramodern medical facilities. Hyderabad combines cutting-edge dental care with affordable costs and rich cultural heritage.",
      clinics: 20,
      rating: 4.7,
      highlights: [
    ...
    },
    {
      ...
      state: "Goa",
      image:
        "https://images.unsplash.com/photo-1625505826977-66d796089d73?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxHb2ElMjBiZWFjaCUyMHBhbG18ZW58MXx8fHwxNzYzMjgyNTI5fDA&ixlib=rb-4.1.0&q=80&w=1080",
      description:
        "Perfect blend of dental care and beach vacation. Recover in paradise with pristine beaches, Portuguese heritage, and a relaxed atmosphere that promotes healing.",
      clinics: 15,
      rating: 4.8,
      highlights: [
    ...
    <div className="pt-20">
      ...
      <div className="relative h-96 flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1662408976803-d94e2e0cb57a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxNdW1iYWklMjBza3lsaW5lJTIwY2l0eXxlbnwxfHx8fDE3NjMyODI1Mjh8MA&ixlib=rb-4.1.0&q=80&w=1080)",
          }}
        />
        <div className="absolute inset-0 bg-linear-to-r from-black/70 to-black/50"></div>

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h1 className="text-white mb-4">Destinations</h1>
          <p className="text-white/90 max-w-2xl mx-auto mb-8">
            Choose from India's premier cities, each offering world-class dental
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-center">
                      <div className="flex items-center gap-1 mb-1">
                        <Star
                          className="text-[#00A676] fill-[#00A676]"
                          size={20}
                        />
                  ...
                  <div className="w-full lg:w-3/5">
                    ...
                    <div className="mb-8">
                      <h3 className="text-gray-900 mb-4">
                        Why Choose {destination.city}?
                      </h3>
                      <ul className="space-y-3">
                        {destination.highlights.map((highlight, i) => (
                          <li key={i} className="flex items-start gap-3">
                            <div className="w-6 h-6 rounded-full bg-[#00A676]/10 flex items-center justify-center shrink-0 mt-0.5">
                    ...
                    <div className="mb-8">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {destination.attractions.map((attraction, i) => (
                          <span
                            key={i}
                            className="px-4 py-2 bg-linear-to-r from-[#007AB6]/10 to-[#00A676]/10 text-gray-700 rounded-full"
                          >
                            {attraction}
                          </span>
                        ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We work with ISO-certified, JCI-accredited dental clinics that
            ...
            {[
              {
                ...
                specialties: "Implants, Veneers, Full Mouth",
                image:
              ...
              },
              {
                ...
                specialties: "General Dentistry, Aesthetic",
                image:
                  "https://images.unsplash.com/photo-1762625570087-6d98fca29531?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBkZW50YWwlMjBvZmZpY2V8ZW58MXx8fHwxNzYzMjEwNzg2fDA&ixlib=rb-4.1.0&q=80&w=1080",
              },
            ].map((clinic, index) => (
              <div
                key={index}
                className="bg-white rounded-lg overflow-hidden shadow-[0_4px_10px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,122,182,0.15)] transition-all duration-300"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2 text-xs">
                    <span className="px-2 py-1 bg-[#007AB6]/10 text-[#007AB6] rounded">
                      ISO
                    </span>
                    <span className="px-2 py-1 bg-[#007AB6]/10 text-[#007AB6] rounded">
                      JCI
                    </span>
                    <span className="px-2 py-1 bg-[#00A676]/10 text-[#00A676] rounded">
                      English
                    </span>
                  </div>
                </div>
      ...
      <div className="py-16 bg-[#007AB6] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-white mb-4">
            Ready to Plan Your Dental Journey?
          </h2>
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            Get a customized treatment plan, clinic recommendations, and travel
